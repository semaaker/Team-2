...
const IMG = {
  techSummit:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAnnFjFN-8ZQTH9k1gARkDo_OqOdch-lp1z2AqN0CKceQ_ZZkhodcBmcZmA5zJhEjrRwkyhfFOwz6s1FCa_M3Te5lZi8FqP2Y0-UYQdffF1_i8rX5EDHXvatdUkFLS9RTiRWpE4gzVH_LFRUskpe5AhRSty4JxA1mraL8PmShRzCcO9hkdYy8z5AtuIKezI9ij13nMKUVGLHIYFd5wqYLJbKOJaTWoJAiRI5PRd-k4l0JnSfg22wurPfgy4kApCCzHiNWofsCavvKo',
  health:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAYmjdvT08g0Ve9sh9Tyo1vUHREsRfDQDwAMzpijvIMDA2pO6cbxnJITkrlDc8xVbFjMaLwhnmI8_ZYXw88-RSxrXJ_67I4yLXIFfa8M1W4EgJZ5adtqS5xauHe96kjLzuHijdWNDy4wueDbqHAoH9b_VQ6VYFiOUDj9StYqLTLnh15zvZlVob6I-TwJg4HctQLQrp68R4h5qIYJvae4PsaYErysGn-5_oXAiD3zif2nwz_rCh9aR_D6-djzdYdLGsUJz6YZt5xOaA',
  fintech:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAwwxg-9VrHP_wpcI7bZRfG0Pm_X4ovLg0C_ppoBw8m3ZxVgQkECGsyJtbk9cLchOuOKT_xJt1z7KmrvoLM4fIZpI0Mt9qX7il_E50fjZLY_wZF0p_XZFC6ComlW-xGcqMXRaONpAEhXuiDPnH-V3BS75foetnjU72u9fyOzG0WJFYkBjMHetEd6rf9Nyr35hpuca_KfwfdDu10mSJPAoT7z-TVu1pvKL4ylRZrcSVOmgOPU83CgyHN2pcprNQGOXMT8lzKHaIyj8E',
  sustainability:
  ...
  creative:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuA2Taqs6s2Nn7TD3vRsMubs1OeRNZNTsarqFHC4SKfTjdGDYNAGHsOT8JeLWCt2xI8aneFTPXpSyhBVlqfiKImBWLIo0ulLYiQQYalBvOs5Rk8w0M3Fmj3QuQ9q-HVYgXVBKIjpJzEhkcmVYUjY6XQAAaIoJQNbLETXanfSFGEkutS2sl08kd-h0hMOrTT9fr-mJchqMKHwyOFiA5-cwGsAGjrK8d8p8wLTDS9OjYGvARKZubzs0K3u3f7TvN24hmVA5xze6yhugDU',
  medical:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAFAVGbs-6WTKYcKevEMeLbCRlsOw6fCVFdpDJe4qn0etbmrVGCqzboaQhF9BlT4HZgmcErzhcwMrciHbv-95WtgNd38Eewix4GxggUL_T986o4WbOwJzk8iv2GKNKqofKm3IBzkrSxWCxGpSvpHjZ5KeJAYUzdTAB2pNPh7G-IhOV9LJiCc0kJW3PlUtzSOy_p8e0v5mhaV6f_tc_ylNAIr4pJ4gGDxYmPPEMZQTY0RfL4_4ZrsZK-guVIEALZE1OOS9M3qV-QXDA',
  avatarOrganizer:
  ...
  avatarSponsor:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuCEnkHrsP0P0Gj9g6etps8ik1nMGftZQxNh4gd_FjvEDl56YGKucpphRFBEzGVviplQQSuPeu2RSoYEp_cTcqOR2BYU6RbnnOCXmJD7r7PpNS2xCPwaI-Pc8cmKBaxldWTUHIOu0JFx-Vs9J3msWiLwZ8znHzlNkpCriG5Z_uRQaAkuKaouTSYEN0UZYbjpaVUIQY_1nDn7CDR1SOg0UOJcQzT7hYx185YnQRoRvylWcMx7CZMR8Q7lkiAegBO8yeBcE4RW9HDOWCY',
} as const;
...
export const seedEvents: EventItem[] = [
  {
    ...
    location: 'İstanbul',
    description:
      'Blok zinciri mimarları, merkeziyetsiz uygulama geliştiricileri ve kurumsal yatırımcıları buluşturan bölgenin en kapsamlı Web3 buluşması.',
  ...
  },
  {
    ...
    location: 'İstanbul',
    description:
      'Yazılım geliştiriciler, BT liderleri ve teknoloji girişimcileri için yapay zeka odaklı en büyük buluşma.',
    attendeesLabel: '5.000+',
    attendees: 5000,
    coverImageUrl: IMG.techSummit,
    status: 'seeking',
  ...
  },
  {
    ...
    location: 'Ankara',
    description:
      'Tıp profesyonellerini ve teknoloji mucitlerini teletıp ve giyilebilir teşhis cihazlarını tartışmak üzere bir araya getiriyor.',
  ...
  },
  {
    ...
    location: 'İstanbul',
    description:
      'Finansal teknolojilerin yeni dalgasını, blok zinciri altyapısını ve dijital bankacılık çözümlerini keşfedin.',
  ...
  },
  {
    ...
    location: 'Ankara',
    description:
      'Yenilenebilir enerji yatırımcıları, belediyeler ve akıllı şehir teknolojisi üreticilerinin ortak platformu.',
    attendeesLabel: '1.200+',
    attendees: 1200,
  ...
  },
  {
    ...
    location: 'İzmir',
    description:
      'Şehir merkezinde üç gün süren, deneyimsel pazarlama aktivasyonlarına açık yaratıcı endüstriler festivali.',
  ...
  },
  {
    ...
    location: 'Antalya',
    description:
      'Klinik araştırmacılar ve medikal cihaz üreticilerinin bir araya geldiği bilimsel kongre.',
    attendeesLabel: '800',
    attendees: 800,
...
export const seedSponsors: Sponsor[] = [
  {
    ...
    about:
      'Global Finans, kurumsal bankacılık ve yatırım çözümleri sunan, 40 ülkede faaliyet gösteren bir finans grubudur. Etkinlik sponsorluklarını marka bilinirliği ve nitelikli müşteri kazanımı hedefleriyle yürütür.',
    ...
    aiAnalysis: {
      score: 98,
      summary:
        'Marka konumlandırması ve hedef kitle profili, etkinliğinizin katılımcı demografisiyle çok yüksek örtüşme gösteriyor.',
      strengths: [
  ...
  },
  {
    ...
    logoIcon: 'business',
    about:
      'Kurumsal bulut altyapısı ve yapay zeka çözümleri geliştiren teknoloji şirketi. Geliştirici topluluklarına yönelik etkinliklerde aktif sponsorluk yürütür.',
    ...
    aiAnalysis: {
      score: 92,
      summary:
        'Teknoloji odaklı etkinliklerde güçlü geçmiş performans; geliştirici kitlesine erişimde etkili.',
      strengths: [
  ...
  },
  {
    ...
    logoIcon: 'storefront',
    about:
      'Rüzgâr ve güneş enerjisi santralleri işleten, sürdürülebilirlik odaklı etkinliklerde ana sponsorluk arayan enerji şirketi.',
    ...
    aiAnalysis: {
      score: 85,
      summary:
        'ESG temalı etkinliklerde güçlü uyum; teknoloji odaklı içerikte orta düzeyde eşleşme.',
...
export const seedSponsorships: Sponsorship[] = [
  {
    id: 'sps_1',
    eventId: 'evt_tech',
...
export const seedPaymentMethod: PaymentMethod = {
  brand: 'Visa',
  last4: '4242',
  expiry: '08/28',
...
export const seedLegalDocs: LegalDocument[] = [
  {
    slug: 'gizlilik',
